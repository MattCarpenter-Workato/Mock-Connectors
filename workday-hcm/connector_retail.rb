...
#
# Demo flavor: a believable RETAIL workforce anchored on Lark & Finch Apparel
# (the same company used as the anchor account in the Salesforce Retail mock).
# Recurring cross-connector personas (Eleanor Vance, Marcus Reyes, Priya Raman,
# Tobias Greer, James Whitfield) appear here as the workforce. The joiner /
# mover / leaver (JML) story is the universal Workday use case.
# ============================================================================

{
  title: 'Mock Workday HCM (Retail)',
  ...
  test: lambda do |connection|
    {
      status: 'ok',
      connected: true,
      tenant: connection['tenant_label'].presence || 'Demo Workday (Retail)',
  ...
  methods: {
    ...
    # A believable RETAIL workforce anchored on Lark & Finch Apparel. All IDs
    ...
    # James Whitfield also appear in the Salesforce Retail mock.
    # ========================================================================
    mock_data: lambda do
      {
        'Organization' => [
          { 'Org_ID' => 'WD-ORG-000001', 'Name' => 'Lark & Finch Apparel',
            'Org_Type' => 'Company', 'Manager_ID' => 'WD-EMP-000001',
            'Parent_Org_ID' => nil, 'Member_Count' => 8 },
          { 'Org_ID' => 'WD-ORG-000002', 'Name' => 'Retail Operations',
          ...
          { 'Org_ID' => 'WD-ORG-000004', 'Name' => 'CC-10001 Stores & Digital',
        ...
        'Worker' => [
          ...
          { 'Worker_ID' => 'WD-EMP-000001', 'Employee_Number' => 'E10001',
            ...
            'Email' => 'eleanor.vance@larkandfinch.example.com',
          ...
          { 'Worker_ID' => 'WD-EMP-000002', 'Employee_Number' => 'E10002',
            ...
            'Email' => 'marcus.reyes@larkandfinch.example.com',
          ...
          { 'Worker_ID' => 'WD-EMP-000003', 'Employee_Number' => 'E10003',
            ...
            'Email' => 'priya.raman@larkandfinch.example.com',
          ...
          # 4. Director of Retail Operations.
          { 'Worker_ID' => 'WD-EMP-000004', 'Employee_Number' => 'E10004',
            ...
            'Email' => 'tobias.greer@larkandfinch.example.com',
            'Position_Title' => 'Director of Retail Operations', 'Department' => 'Retail Operations',
            'Cost_Center' => 'CC-10001', 'Manager_ID' => 'WD-EMP-000001',
          ...
          { 'Worker_ID' => 'WD-EMP-000005', 'Employee_Number' => 'E10005',
            ...
            'Email' => 'hannah.brooks@larkandfinch.example.com',
            'Position_Title' => 'Merchandising Analyst', 'Department' => 'Merchandising',
          ...
          { 'Worker_ID' => 'WD-EMP-000006', 'Employee_Number' => 'E10006',
            ...
            'Email' => 'daniel.osei@larkandfinch.example.com',
            'Position_Title' => 'Store Systems Specialist', 'Department' => 'Retail Operations',
            'Cost_Center' => 'CC-10001', 'Manager_ID' => 'WD-EMP-000004',
            'Hire_Date' => '2019-04-22', 'Status' => 'Active', 'Worker_Type' => 'Employee',
            'Location' => 'Brooklyn, NY', 'Work_Phone' => '+1-718-555-0106',
          ...
          { 'Worker_ID' => 'WD-EMP-000007', 'Employee_Number' => 'E10007',
            ...
            'Email' => 'maria.santos@larkandfinch.example.com',
          ...
          { 'Worker_ID' => 'WD-EMP-000008', 'Employee_Number' => 'C20001',
            ...
            'Email' => 'james.whitfield@contractor.larkandfinch.example.com',
        ...
        'Position' => [
          ...
          { 'Position_ID' => 'WD-POS-000004', 'Title' => 'Director of Retail Operations',
            'Department' => 'Retail Operations', 'Grade' => 'Grade-13', 'Is_Open' => false,
            'Headcount_Budget' => 1, 'Incumbent_ID' => 'WD-EMP-000004' },
          # Open req -- the target for the "joiner" demo.
          { 'Position_ID' => 'WD-POS-000005', 'Title' => 'E-commerce Manager',
            'Department' => 'Merchandising', 'Grade' => 'Grade-10', 'Is_Open' => true,
            'Headcount_Budget' => 2, 'Incumbent_ID' => nil },
          { 'Position_ID' => 'WD-POS-000006', 'Title' => 'Merchandising Analyst',
            'Department' => 'Merchandising', 'Grade' => 'Grade-08', 'Is_Open' => false,
