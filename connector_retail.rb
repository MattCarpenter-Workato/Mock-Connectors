...
#
# Demo flavor: a believable RETAIL / E-COMMERCE CRM (apparel & fashion,
# grocery, beauty, home goods, sporting goods, footwear, and marketplaces).
# ============================================================================

{
  title: 'Mock Salesforce (Retail)',
    ...
    fields: [
      {
        ...
        default: 'Demo Salesforce (Retail)'
      }
    ],
  ...
  methods: {
    ...
    # A believable RETAIL / E-COMMERCE book of business.
    ...
    mock_data: lambda do
      {
        'User' => [
          { 'Id' => '005RM0000001AAAAAA', 'Name' => 'Dana Whitfield',
            'Email' => 'dwhitfield@demo-retail.example.com', 'IsActive' => true,
            'Username' => 'dwhitfield@demo-retail.example.com' },
          { 'Id' => '005RM0000002BBBBBB', 'Name' => 'Marcus Lindqvist',
            'Email' => 'mlindqvist@demo-retail.example.com', 'IsActive' => true,
            'Username' => 'mlindqvist@demo-retail.example.com' },
          { 'Id' => '005RM0000003CCCCCC', 'Name' => 'Priya Raman',
            'Email' => 'praman@demo-retail.example.com', 'IsActive' => true,
            'Username' => 'praman@demo-retail.example.com' },
          { 'Id' => '005RM0000004DDDDDD', 'Name' => 'Tobias Greer',
            'Email' => 'tgreer@demo-retail.example.com', 'IsActive' => true,
            'Username' => 'tgreer@demo-retail.example.com' },
          { 'Id' => '005RM0000005EEEEEE', 'Name' => 'Sofia Castellano',
            'Email' => 'scastellano@demo-retail.example.com', 'IsActive' => false,
            'Username' => 'scastellano@demo-retail.example.com' }
        ],

        'Account' => [
          { 'Id' => '001RM0000001AAAAAA', 'Name' => 'Lark & Finch Apparel',
            'Industry' => 'Apparel & Fashion', 'AnnualRevenue' => 240_000_000, 'Type' => 'Customer',
            'OwnerId' => '005RM0000001AAAAAA', 'Website' => 'https://larkandfinch.example.com',
            'CreatedDate' => '2025-01-14T09:12:00Z', 'LastModifiedDate' => '2026-05-02T16:40:00Z' },
          { 'Id' => '001RM0000002AAAAAA', 'Name' => 'Summit Outdoor Co.',
            'Industry' => 'Sporting Goods', 'AnnualRevenue' => 185_000_000, 'Type' => 'Customer',
            'OwnerId' => '005RM0000002BBBBBB', 'Website' => 'https://summitoutdoor.example.com',
            'CreatedDate' => '2025-02-03T11:30:00Z', 'LastModifiedDate' => '2026-04-18T08:05:00Z' },
          { 'Id' => '001RM0000003AAAAAA', 'Name' => 'Harborview Grocers',
            'Industry' => 'Grocery', 'AnnualRevenue' => 760_000_000, 'Type' => 'Customer',
            'OwnerId' => '005RM0000003CCCCCC', 'Website' => 'https://harborviewgrocers.example.com',
            'CreatedDate' => '2025-03-22T14:45:00Z', 'LastModifiedDate' => '2026-05-29T13:22:00Z' },
          { 'Id' => '001RM0000004AAAAAA', 'Name' => 'Glow Beauty',
            'Industry' => 'Health & Beauty', 'AnnualRevenue' => 58_000_000, 'Type' => 'Prospect',
            'OwnerId' => '005RM0000001AAAAAA', 'Website' => 'https://glowbeauty.example.com',
            'CreatedDate' => '2025-06-10T10:00:00Z', 'LastModifiedDate' => '2026-06-01T09:15:00Z' },
          { 'Id' => '001RM0000005AAAAAA', 'Name' => 'UrbanNest Home',
            'Industry' => 'Home Goods', 'AnnualRevenue' => 132_000_000, 'Type' => 'Customer',
            'OwnerId' => '005RM0000004DDDDDD', 'Website' => 'https://urbannesthome.example.com',
            'CreatedDate' => '2025-08-19T08:20:00Z', 'LastModifiedDate' => '2026-03-11T17:48:00Z' },
          { 'Id' => '001RM0000006AAAAAA', 'Name' => 'Pace Athletics',
            'Industry' => 'Footwear/Athletics', 'AnnualRevenue' => 410_000_000, 'Type' => 'Prospect',
            'OwnerId' => '005RM0000003CCCCCC', 'Website' => 'https://paceathletics.example.com',
        ...
        'Contact' => [
          { 'Id' => '003RM0000001AAAAAA', 'FirstName' => 'Eleanor', 'LastName' => 'Voss',
            'Email' => 'eleanor.voss@larkandfinch.example.com', 'Title' => 'VP E-commerce',
          ...
          { 'Id' => '003RM0000002AAAAAA', 'FirstName' => 'Raj', 'LastName' => 'Patel',
            'Email' => 'raj.patel@larkandfinch.example.com', 'Title' => 'Director of Merchandising',
            'AccountId' => '001RM0000001AAAAAA', 'OwnerId' => '005RM0000001AAAAAA',
          ...
          { 'Id' => '003RM0000003AAAAAA', 'FirstName' => 'Grace', 'LastName' => 'Okafor',
            'Email' => 'grace.okafor@summitoutdoor.example.com', 'Title' => 'Head of Digital',
          ...
          { 'Id' => '003RM0000004AAAAAA', 'FirstName' => 'Liam', 'LastName' => 'Donnelly',
            'Email' => 'liam.donnelly@harborviewgrocers.example.com', 'Title' => 'Director of Store Operations',
          ...
          { 'Id' => '003RM0000005AAAAAA', 'FirstName' => 'Hannah', 'LastName' => 'Kim',
            'Email' => 'hannah.kim@glowbeauty.example.com', 'Title' => 'CMO',
          ...
          { 'Id' => '003RM0000006AAAAAA', 'FirstName' => 'Marcus', 'LastName' => 'Bauer',
            'Email' => 'marcus.bauer@urbannesthome.example.com', 'Title' => 'VP Supply Chain',
          ...
          { 'Id' => '003RM0000007AAAAAA', 'FirstName' => 'Yuki', 'LastName' => 'Tanaka',
            'Email' => 'yuki.tanaka@paceathletics.example.com', 'Title' => 'Loyalty Program Manager',
        ...
        'Lead' => [
          { 'Id' => '00QRM0000001AAAAAA', 'FirstName' => 'Olivia', 'LastName' => 'Nash',
            'Company' => 'Maple & Co. Boutiques', 'Email' => 'onash@mapleandco.example.com',
          ...
          { 'Id' => '00QRM0000002AAAAAA', 'FirstName' => 'Devon', 'LastName' => 'Reyes',
            'Company' => 'Driftwood Surf Supply', 'Email' => 'dreyes@driftwoodsurf.example.com',
          ...
          { 'Id' => '00QRM0000003AAAAAA', 'FirstName' => 'Amara', 'LastName' => 'Singh',
            'Company' => 'FreshCart Markets', 'Email' => 'asingh@freshcartmarkets.example.com',
          ...
          { 'Id' => '00QRM0000004AAAAAA', 'FirstName' => 'Felix', 'LastName' => 'Moreau',
            'Company' => 'Lumen Cosmetics', 'Email' => 'fmoreau@lumencosmetics.example.com',
          ...
          { 'Id' => '00QRM0000005AAAAAA', 'FirstName' => 'Bianca', 'LastName' => 'Ferraro',
            'Company' => 'Trailhead Gear', 'Email' => 'bferraro@trailheadgear.example.com',
            'Status' => 'Open - Not Contacted', 'LeadSource' => 'Web', 'IsConverted' => false,
            'OwnerId' => '005RM0000002BBBBBB',
        ...
        'Opportunity' => [
          { 'Id' => '006RM0000001AAAAAA', 'Name' => 'Lark & Finch - Omnichannel/POS Rollout',
          ...
          { 'Id' => '006RM0000002AAAAAA', 'Name' => 'Summit Outdoor - Loyalty Program Launch',
          ...
          { 'Id' => '006RM0000003AAAAAA', 'Name' => 'Harborview - Order Management (OMS) Integration',
          ...
          { 'Id' => '006RM0000004AAAAAA', 'Name' => 'Glow Beauty - Headless Commerce Replatform',
          ...
          { 'Id' => '006RM0000005AAAAAA', 'Name' => 'UrbanNest - Customer Data Platform',
          ...
          { 'Id' => '006RM0000006AAAAAA', 'Name' => 'Pace Athletics - Returns Automation',
        ...
        'Case' => [
          { 'Id' => '500RM0000001AAAAAA', 'CaseNumber' => '00001001',
            'Subject' => 'Checkout failing at payment step', 'Status' => 'Working',
          ...
          { 'Id' => '500RM0000002AAAAAA', 'CaseNumber' => '00001002',
            'Subject' => 'Inventory not syncing to storefront', 'Status' => 'Escalated',
          ...
          { 'Id' => '500RM0000003AAAAAA', 'CaseNumber' => '00001003',
            'Subject' => 'Returns/RMA webhook not firing', 'Status' => 'New',
          ...
          { 'Id' => '500RM0000004AAAAAA', 'CaseNumber' => '00001004',
            'Subject' => 'Loyalty points not crediting', 'Status' => 'Closed',
          ...
          { 'Id' => '500RM0000005AAAAAA', 'CaseNumber' => '00001005',
            'Subject' => 'Order status updates delayed in app', 'Status' => 'Working',
