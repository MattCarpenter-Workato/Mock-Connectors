    ...
    mock_data: lambda do
      {
        'User' => [
          { 'Id' => '005RM0000001AAAAAA', 'Name' => 'James Whitfield',
            'Email' => 'jwhitfield@demo-hc.example.com', 'IsActive' => true,
            'Username' => 'jwhitfield@demo-hc.example.com' },
          { 'Id' => '005RM0000002BBBBBB', 'Name' => 'Marcus Reyes',
            'Email' => 'mreyes@demo-hc.example.com', 'IsActive' => true,
            'Username' => 'mreyes@demo-hc.example.com' },
        ...
        'Contact' => [
          { 'Id' => '003RM0000001AAAAAA', 'FirstName' => 'Eleanor', 'LastName' => 'Vance',
            'Email' => 'eleanor.vance@cedarvalleyhealth.example.com', 'Title' => 'Chief Medical Officer',
